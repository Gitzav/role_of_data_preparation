...
Usage in Jupyter:
    ...
    run_analysis('rolling_sale_data.xlsx')
"""
...
def analyze_data_types(raw_data):
    """Analyze and display data types."""
    print("\n" + "="*80)
...
def visualize_categorical_distribution(raw_data, categorical_cols):
...
def visualize_numerical_distribution(raw_data, numerical_cols):
...
def analyze_correlation(raw_data):
...
def analyze_year_built(raw_data):
...
def detect_noise_ppsf(raw_data):
    """Detect and visualize noise using PPSF method."""
    print("\n" + "="*80)
    ...
    return raw_data_with_ppsf, noise_data, normal_data

def visualize_outlier_summary(noise_data, normal_data):
    """Visualize outlier filtering summary."""
    print("\n" + "="*80)
...
def analyze_tax_class(raw_data):
    """Analyze tax class distribution."""
    print("\n" + "="*80)
...
def analyze_sale_price_log_transformation(raw_data_with_ppsf):
    """Analyze sale price log transformation."""
    print("\n" + "="*80)
...
def run_analysis(filepath='data\rolling_sale_data.xlsx'):
    """
    Run complete real estate analysis pipeline.
    
    Parameters:
    -----------
    filepath : str
        Path to the Excel file containing rolling sale data.
        Default: 'rolling_sale_data.xlsx'
    """
    # Load data
    df = load_data(filepath)
    
    # Clean data
    raw_data = clean_data(df)
    
    # Analyze data types
    categorical_cols, numerical_cols = analyze_data_types(raw_data)
    
    # Visualize categorical distribution
    visualize_categorical_distribution(raw_data, categorical_cols)
    
    # Visualize numerical distribution
    visualize_numerical_distribution(raw_data, numerical_cols)
    
    # Analyze correlation
    analyze_correlation(raw_data)
    
    # Analyze year built
    analyze_year_built(raw_data)
    
    # Detect noise using PPSF
    raw_data_with_ppsf, noise_data, normal_data = detect_noise_ppsf(raw_data)
    
    # Visualize outlier summary
    visualize_outlier_summary(noise_data, normal_data)
    
    # Analyze tax class
    analyze_tax_class(raw_data)
    
    # Analyze sale price log transformation
    analyze_sale_price_log_transformation(raw_data_with_ppsf)
